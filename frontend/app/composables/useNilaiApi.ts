...
export const useNilaiApi = () => {
   ...
   * POST /nilai/komponen
   */
  const createKomponen = async (data: CreateKomponenRequest): Promise<ApiResponse<KomponenNilai>> => {
   ...
   */
  const getKomponenByKelas = async (kelasId: string): Promise<ApiResponse<KomponenNilai[]>> => {
   ...
   * POST /nilai/entry
   */
  const entryNilai = async (data: EntryNilaiRequest): Promise<ApiResponse<{ message: string; nilai: Nilai }>> => {
   ...
   * PATCH /nilai/:id
   */
  const updateNilai = async (id: string, data: UpdateNilaiRequest): Promise<ApiResponse<Nilai>> => {
   ...
   */
  const getNilaiByKelas = async (kelasId: string): Promise<ApiResponse<NilaiByKelas>> => {
